...
return [
    ...
    */
    ...
    'category-slug-not-unique'=>"Uma categoria com esse slug ja existe",
    'list-fields-errors-message'=> "Faltaram algumas coisas.",
    'video-type-error-message'=> "O arquivo enviado não é um vídeo válido.
Apenas os formatos MP4, MPEG ou QuickTime (MOV) são aceitos."
